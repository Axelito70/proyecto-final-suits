...
<div class="container mt-5">
    <div class="row justify-content-center bg-card">
        ...
        <h2 class="titulo-restaurante">Listado de productos</h2>
        </div>
                    ...
                    <div class="col-md-10">
                        <div class="form-floating mb-3">
                            <input class="form-control" id="producto" name="producto" type="text"
                                placeholder="Producto">
                            <label class="text-primary" for="usuario"><i class="fa-solid fa-truck"></i>Producto</label>
                        </div>
                        <div class="form-floating mb-3">
                            <input class="form-control" id="precio" name="precio" type="text" placeholder="Precio">
                            <label class="text-primary" for="usuario"><i class="fa-solid fa-dollar-sign"></i></i>Precio</label>
                        </div>
                        <div class="form-floating mb-3">
